...
function Header() {
    ...
    return (
        <header className='relative flex items-center justify-between h-[4.5rem] md:h-[4rem] pl-[1.5rem] md:pl-[1.8rem]  lg:pt-[0rem] lg:ml-[3rem]  pr-[1.5rem]  md:pr-0 '>
            ...
            {state.clicked?
            <div className={`z-30 absolute right-0 top-0 flex flex-col gap bg-[#1f232d] opacity-90 w-[68%] h-[100vh] pt-[7rem] pl-[2rem]`}>
                <NavItems />
            </div>:
            null}
        </header>
